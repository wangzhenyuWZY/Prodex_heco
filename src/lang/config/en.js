module.exports = {
  ...
  wtrx: {
    yog: 'You will get',
    Whatis: 'Whatis',
    titn: 'ETH is the native asset of TRON, and WETH is a ERC20 Token with the equivalent value to ETH.',
    titn1: 'Deposit ETH to mint an equivalent amount of WETH, and burn WETH to get an equivalent amount of ETH.',
    CWetTRC20: 'Can WETH exchange to other ERC20 Tokens?',
    wtitn: 'WETH is a ERC20 Token, you can swap to any other ERC20 Tokens on FOX.',
    petao: 'Please enter the amout of WETH',
    petao1: 'Please enter the amout of ETH'
  ...
  Stake: {
    ...
    sfox: 'To stake FOX_LP tokens, acquire',
    stfe: 'Total FOX Earned',
    syuf: 'Your Unstaked FOX_LP',
    sysfl: 'Your Staked FOX_LP',
