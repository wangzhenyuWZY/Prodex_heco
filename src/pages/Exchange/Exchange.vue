<template>
  <div>
    <div class="container exchange ">
        ...
        <div slot="body">
          <div class="setInput clearfix">
            ...
            <div class="ctx_3 fl_lt">
              <setselect :showSelect="JSON.stringify(token1)!='{}'" :imgUrl="token1.img" item='0' :balance="token1.balance" :text="token1.name"
                         @click="showSelect(0)" />
            </div>
          </div>
          ...
          <div class="setInput clearfix">
            ...
            <div class="ctx_3 fl_lt">
              <setselect :showSelect="JSON.stringify(token2)!='{}'" :imgUrl="token2.img" item='1' :balance="token2.balance" :text="token2.name"
                         @click="showSelect(1)" />
            </div>
          </div>
          ...
          <div class="whe" :class="connectFlag?'login_text':'outlogin'">
            <div class="connect_btn clearfix">
              ...
              <div class="whe fl_rg" v-show="!Approved()">
                <span>
                  <el-button class="from_botton" v-show="!connectFlag" @click="btnClick"> <img class="whe_img" src="@/assets/img/icon_my_wallet.svg"
      ...
      <change v-if="isConfirm" @doConfirm="doswap" :token1='token1' :token2='token2' :token1Num='token1Num' :token2Num='token2Num'
              :spotPrice='spotPrice' :swapFee='thisswapFee' :percentage='percentage' @handleClosea="isConfirm = false" />
