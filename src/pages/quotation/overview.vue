  ...
  <div class="container">
    ...
    <div class="quoContent clearfix">
      ...
      <div class="rightCon">
        ...
        <h2 class="quoTitle">Top Pairs<router-link to="#" class="more">See All</router-link></h2>
        <div class="tableCon">
          <el-table
            :data="tableData"
            class='elTable'
        ...
        <div class="tableCon">
          <el-table
            ...
            <el-table-column
              ...
              <template  slot-scope="scope">
                <span class="pairName">{{scope.row.date}}</span>
              </template>
            </el-table-column>
            <el-table-column
              prop="name"
...
export default {
  ...
  data() {
    return {
      ...
      transData:[
        {
          date: 'Swap USDT for HBTC',
          name: '$3,442',
          province: '23,233 USDT',
          city: '2,323 HBTC',
          address: '23wesd23dsdfsdf',
          zip: '1 hour ago'
        }, {
          date: 'Swap USDT for HBTC',
          name: '$3,442',
